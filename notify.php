...
//初始化日志
/*$logHandler= new CLogFileHandler(dirname(__FILE__) . DIRECTORY_SEPARATOR."unit/logs/".date('Y-m-d').'.log');
...
class PayNotifyCallBack extends WxPayNotify
{
	...
	public function NotifyProcess($data, $config, &$msg)
	{
		...
		$our_account = $data['mch_id'];

		/*==========================================*/
		/*===========请在此书写您的业务逻辑*/
		/*==========================================*/
	
		//header("Location:/home/pay_detail?deposits_id=".$item_id);
		return true;
	}
}
